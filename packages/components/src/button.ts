...
export const adsButtonContract = defineComponentContract({
  ...
  cssCustomProperties: [
    ...
    { name: '--ads-button-radius', default: 'var(--ads-radius-control, 0px)' },
    { name: '--ads-button-font-weight', default: 'var(--ads-font-weight-medium, 500)' },
    { name: '--ads-disabled-opacity', default: 'var(--ads-opacity-disabled, 0.5)' },
    { name: '--ads-button-active-brightness', default: '0.9', description: 'Unitless brightness multiplier during enabled pointer activation.' },
    { name: '--ads-button-border-width', default: '1px', description: 'Border width for all button variants; transparent borders still occupy space.' },
    { name: '--ads-button-danger-background', default: 'var(--ads-color-state-danger, #9a251f)', description: 'Danger variant background color.' },
    { name: '--ads-button-danger-color', default: 'var(--ads-color-state-dangerText, #fff)', description: 'Danger variant foreground color.' },
    { name: '--ads-button-ghost-color', default: 'var(--ads-color-text-default, #111111)', description: 'Ghost variant foreground color.' },
    { name: '--ads-button-hover-brightness', default: '0.96', description: 'Unitless brightness multiplier on enabled hover.' },
    { name: '--ads-button-primary-background', default: 'var(--ads-color-action-primary, #111111)', description: 'Primary variant background color.' },
    { name: '--ads-button-primary-color', default: 'var(--ads-color-action-primaryText, #fff)', description: 'Primary variant foreground color.' },
    { name: '--ads-button-secondary-background', default: 'var(--ads-color-surface-default, #fff)', description: 'Secondary variant background color.' },
    { name: '--ads-button-secondary-border', default: 'var(--ads-color-line-control, #6b6b65)', description: 'Secondary variant border color.' },
    { name: '--ads-button-secondary-color', default: 'var(--ads-color-text-default, #111111)', description: 'Secondary variant foreground color.' },
  ],
  states: [
...
export class AdsButton extends FormAssociatedElement {
  static override styles = css`
    ...
    button {
      ...
      border-radius: var(--ads-button-radius, var(--ads-radius-control, 0px));
      font: inherit;
      font-weight: var(--ads-button-font-weight, var(--ads-font-weight-medium, 500));
      line-height: 1;
    ...
    :host([variant='primary']) button {
      background: var(--ads-button-primary-background, var(--ads-color-action-primary, #111111));
      color: var(--ads-button-primary-color, var(--ads-color-action-primaryText, #fff));
    }

    :host([variant='secondary']) button {
      border-color: var(--ads-button-secondary-border, var(--ads-color-line-control, #6b6b65));
      background: var(--ads-button-secondary-background, var(--ads-color-surface-default, #fff));
      color: var(--ads-button-secondary-color, var(--ads-color-text-default, #111111));
    }

    :host([variant='ghost']) button {
      background: transparent;
      color: var(--ads-button-ghost-color, var(--ads-color-text-default, #111111));
    }

    :host([variant='danger']) button {
      background: var(--ads-button-danger-background, var(--ads-color-state-danger, #9a251f));
