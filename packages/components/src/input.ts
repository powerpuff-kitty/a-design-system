...
export const adsInputContract = defineComponentContract({
  ...
  cssCustomProperties: [
    ...
    { name: '--ads-input-border-width', default: '1px', description: 'Control border width.' },
    { name: '--ads-input-description-color', default: 'var(--ads-color-text-muted, #5d5d57)', description: 'Supporting description text color.' },
    { name: '--ads-input-error-color', default: 'var(--ads-color-state-danger, #9a251f)', description: 'Validation message text color.' },
    { name: '--ads-input-focus-border-color', default: 'var(--ads-color-focus-ring, currentColor)', description: 'Control border color while focus is inside the control.' },
    { name: '--ads-input-invalid-border-color', default: 'var(--ads-color-state-danger, #9a251f)', description: 'Control border color while invalid.' },
    { name: '--ads-input-label-font-size', default: '0.875rem', description: 'Visible label text size.' },
    { name: '--ads-input-label-font-weight', default: 'var(--ads-font-weight-medium, 500)', description: 'Visible label font weight.' },
    { name: '--ads-input-label-gap', default: '0.375rem', description: 'Spacing between the visible label and control.' },
    { name: '--ads-input-message-font-size', default: '0.8125rem', description: 'Supporting description and error text size.' },
    { name: '--ads-input-message-gap', default: '0.375rem', description: 'Logical spacing before supporting description and error regions.' },
    { name: '--ads-input-placeholder-color', default: 'var(--ads-color-text-subtle, #76766f)', description: 'Native input placeholder text color.' },
  ],
  states: [
